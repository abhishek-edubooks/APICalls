...
public class xmlToSql {
    ...
    public static void setGetLowestOfferListingsForASIN(Logger logger, String fileName, Connection connection, int batchId){
        try {
            ...
            for (GetLowestOfferListingsForASINResult getLowestOfferListingsForASINResult: result.getGetLowestOfferListingsForASINResult()) {
                ...
                if (responseStatus.equalsIgnoreCase("Success")){
                    ...
                    // Update AllIsbn.
                    updateTracker(connection, "UPDATE `DataEngine`.`AllIsbn` SET GetLowestOfferListingsForASIN=true WHERE ASIN='" + asin + "'");

                } else
                    logger.severe("Status: " + responseStatus + " | ASIN: " + getLowestOfferListingsForASINResult.getASIN() + " | batchId: " + batchId);
            }
