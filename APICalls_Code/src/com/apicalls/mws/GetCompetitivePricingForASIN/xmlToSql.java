...
public class xmlToSql {
    ...
    public static void setGetCompetitivePricingForASIN(Connection connection, Logger logger, String fileName, int batchId){
        try {
                ...
                if (responseStatus.equalsIgnoreCase("Success")){
                    ...
                    try {
                        ...
                        updateTracker(connection, "UPDATE `DataEngine`.`AllIsbn` SET GetCompetitivePricingForASIN = true," +
                                " trials_GetCompetitivePricingForASIN = 0 WHERE ASIN='" + asin + "'");
