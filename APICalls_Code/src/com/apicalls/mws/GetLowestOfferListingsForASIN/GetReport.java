...
public class GetReport {
    ...
    private static String invokeGetLowestOfferListingsForASIN( MarketplaceWebServiceProducts client,
        ...
        try {
            ...
            fw.write((client.getLowestOfferListingsForASIN(request).toXML())
    ...
    public static String getLowestOfferListingsForASIN( Map<String, String> configuration,
                                                        Logger logger,
                                                        String fileName,
                                                        List<String> asin) {
        ...
        // Make the call.
        return invokeGetLowestOfferListingsForASIN(client, request, logger, fileName);
    }
